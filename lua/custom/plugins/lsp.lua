  ...
  },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        -- capabilities = capabilities, -- will be merged in by your handler
        -- },
        --
        ...
        eslint = {
          ...
          root_dir = require('lspconfig.util').root_pattern('.eslintrc.js', '.eslintrc.cjs', '.eslintrc.json', 'eslint.config.js', 'package.json'),
          settings = {
            format = { enable = true },
          },
        },
